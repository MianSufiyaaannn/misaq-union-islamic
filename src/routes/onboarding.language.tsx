...
const langs = [
  {
    ...
    name: "English",
    native: "English",
    sample: "Marriage in the light of the Sunnah.",
  },
  { code: "ur" as const, name: "Urdu", native: "اُردُو", sample: "سنّت کی روشنی میں نکاح۔" },
  {
    ...
    name: "Roman Urdu",
    native: "Roman",
    sample: "Sunnah ki roshni mein nikah.",
  },
];
    ...
    <PhoneFrame>
      <div className="flex h-full flex-col px-6 pb-10 pt-[calc(1.5rem+env(safe-area-inset-top))] overflow-y-auto">
        ...
        <button
          ...
          className="mt-auto w-full rounded-full bg-primary py-4 font-medium text-primary-foreground shadow-elegant"
        >
          {t("lang.continue")}
        </button>
      </div>
