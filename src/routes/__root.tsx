  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-block rounded-full bg-primary px-6 py-3 text-primary-foreground">
          Return to Misaq
        </a>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Misaq is a premium Islamic matrimonial platform where marriage is conducted with dignity, family involvement, and the values of the deen." },
      { name: "theme-color", content: "#6B121F" },
      { property: "og:title", content: "Misaq — Islamic Matrimonial Platform" },
      { property: "og:description", content: "A trusted matrimonial platform built on Islamic values, with families at the centre." },
